...
Last README file update: Wed Nov 20 00:36:43 CST 2024
...
command.ftbbanners
command.ftbbanners.copy-rf-screen-text
command.ftbchunks
...
command.ftbjanitor.clear_area_from_tag
command.ftbjanitor.clear_area_from_tag.radius
command.ftbjanitor.clear_area_from_tag.radius.keep_structures
command.ftbjanitor.clear_area_from_vanilla_blocks
command.ftbjanitor.clear_area_from_vanilla_blocks.radius
command.ftbjanitor.clear_area_from_vanilla_blocks.radius.keep_structures
command.ftbjanitor.dev
command.ftbjanitor.dev.enabled
...
command.ftbjanitor.dump.client_resources
command.ftbjanitor.dump.entity_brains
command.ftbjanitor.dump.heap
command.ftbjanitor.dump.modlist
command.ftbjanitor.dump.registry_keys
command.ftbjanitor.heal
command.ftbjanitor.jer_worldgen
command.ftbjanitor.jer_worldgen.start
command.ftbjanitor.jer_worldgen.stop
command.ftblibrary
...
command.hat
command.hats
command.hats.addCount
command.hats.addCount.player
command.hats.addCount.player.names
command.hats.addCount.player.names.count
command.hats.clear
command.hats.clear.player
command.hats.getHat
command.hats.getHat.target
command.hats.reextract
command.hats.reextract.hats
command.hats.reextract.heads
command.hats.remove
command.hats.remove.player
command.hats.remove.player.names
command.hats.setHat
command.hats.setHat.targets
command.hats.setHat.targets.names
command.hats.setHat.targets.nbt
command.hats.setHat.targets.silent
command.hats.setHat.targets.silent.names
command.hats.setHat.targets.silent.nbt
command.heal
command.heal.player
command.help
...
command.sb
command.sb.delete
command.sb.delete.CONFIRMATION
command.sb.delete.UUID
command.sb.list
command.sb.list.firstOpenedBy
command.sb.list.firstOpenedBy.PlayerName
command.sb.list.lastOpenedBy
command.sb.list.lastOpenedBy.PlayerName
command.sb.open
command.sb.open.UUID
command.sb.recover
command.sb.recover.UUID
command.schedule
...
command.school
command.school.complete
command.school.complete.player
command.school.enter
command.school.enter.school
command.school.enter.school.player
command.school.leave
command.school.leave.player
command.scoreboard
